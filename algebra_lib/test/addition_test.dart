...
//         Variable(n: ScalarProvider.get(2), index: 0),
//         Variable(n: ScalarProvider.get(1), index: 1),
//         Variable(n: ScalarProvider.get(-3), index: 2),
//       ]),
//       ParametrizedScalar(values: [
//         Variable(n: ScalarProvider.get(1), index: 0),
//         Variable(n: ScalarProvider.get(-3), index: 2),
