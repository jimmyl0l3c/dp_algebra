        ...
        return Response(
            {
                ...
                "Block type list": reverse("block-type-list", request=request),
            }
        )
...
urlpatterns = [
    ...
    path("article/<int:pk>/", views.ArticlePageListView.as_view(), name="article-page-list"),
    path("block_type/", views.BlockTypeView.as_view(), name="block-type-list"),
]
